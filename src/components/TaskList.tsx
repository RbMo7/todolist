            ...
            {items.map((item, num) => {
              return (
                <li className="list-group-item " key={num}>
                  ...
                  <button className="btn" onClick={() => deleteItem(item, num)} id="pend">
                    <svg
                  ...
                  <div className="col">
                      <div className="align-middle"><span className="align-middle">{item}</span></div>
                    </div>
                  </div>
                </li>
              );
            ...
            {completedTask.map((item, num) => {
              ...
              return (
                <li className="list-group-item " key={num}>
                  <div className="row">
                    <div className="col-auto">
                      <button className="btn" onClick={() => deleteTask(num)} id="pend">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
